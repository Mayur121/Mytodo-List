...
const deleteAllTask = document.getElementById("clear");
...
function taskUpdate() {
  num.innerHTML = "Number of Tasks : " + numberOfTasks;
}
...
function loadTasks() {
 ...
 tasks = Array.from(JSON.parse(getLocalStorage));

  const pendingNumb = document.querySelector(".pendingNumb");
  pendingNumb.textContent = tasks.length; //pass the length in pendingNumb
  if (tasks.length > 0) {
